...
6. $T(n) = T(n/2) + n$
    ...
    >
    > $$f(\frac{n}{2}) \leq \delta *f(n) \Rightarrow \frac{n}{2} \leq \delta *n$$
    >
...
7. $T(n) = T(n/2) + \sqrt{n}$
    ...
    > - Reemplazando con los datos de nuestro caso nos queda:
    >
    > $$f(\frac{n}{2}) \leq \delta *f(n) \Rightarrow \sqrt{\frac{n}{2}} \leq \delta *\sqrt{n} \Rightarrow \frac{\sqrt{n}}{\sqrt{2}} \leq \delta *\sqrt{n}$$
    >
...
8. $T(n) = T(n/2) + n^2$
    ...
    > - Reemplazando con los datos de nuestro caso nos queda:
    >
    > $$f(\frac{n}{2}) \leq \delta *f(n) \Rightarrow \frac{n^2}{4} \leq \delta *n^2 $$
    >
